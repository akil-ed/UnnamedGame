...
public class PathController_m : MonoBehaviour
{
	...
	// The game grid.
	private GridRenderer_m m_gridRenderer;
	
	// The player movement controller.
	public GridMove_m m_playerGridMove;
	
	// The player controller.
	private PlayerController_m m_playerController;
	
	// The GUIController. 
	GUIController_m m_guiController;
	public static PathController_m instance;
	...
	void Start ()
	{
		...
		m_playerGridMove = GridMove_m.instance;
		m_playerController = PlayerController_m.instance;
	}

	public void InitPlayer(GridRenderer_m renderer)
	{
