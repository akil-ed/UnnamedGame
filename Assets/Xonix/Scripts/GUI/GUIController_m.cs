...
public class GUIController_m : MonoBehaviour {
	...
	public PlayerController_m m_playerController;
	...
	void initializeGame ()
	{
		m_gridRenderer = GameObject.Find("GridRenderer").GetComponent<GridRenderer_m> ();
	...
	void Lives ()
	{
		if (!GameCompleted)
		{
			if (PlayerController_m.instance.PlayerLives <= 0)
				KillPlayer ();
