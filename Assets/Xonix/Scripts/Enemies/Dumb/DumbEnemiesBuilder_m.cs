...
public class DumbEnemiesBuilder_m : MonoBehaviour {
	...
	private void GenerateEnemies ()
	{
		for (int i = 0; i < m_enemiesNumber; i ++)
		{
			...
			Transform e = PhotonNetwork.Instantiate ("dumb", new Vector3 (enemyLocation.x, 0f, enemyLocation.y), Quaternion.identity,new byte()).transform;
